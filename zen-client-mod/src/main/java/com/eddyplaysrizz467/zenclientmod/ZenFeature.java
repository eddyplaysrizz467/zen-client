...
public enum ZenFeature {
  ...
  SPEED_BOOST("speed_boost", "Speed Boost", "Adds a small movement boost while you are moving on the ground."),
  AIR_JUMP("air_jump", "Air Jump", "Lets you jump again while you are still in the air."),
  SAFE_WALK("safe_walk", "Safe Walk", "Stops you from sliding off block edges while moving."),
  AUTO_WALK("auto_walk", "Auto Walk", "Keeps you moving forward even when you stop pressing W."),
  NO_SLOW("no_slow", "No Slow", "Keeps more of your speed while you are using items."),
  SPIDER("spider", "Spider", "Helps you climb upward when you push into walls."),
  PARKOUR("parkour", "Parkour", "Auto-jumps when you run off the edge of a block."),
  ...
  FLIGHT("flight", "Flight", "Lets you fly with configurable mode and speed."),
  ...
  TRACERS("tracers", "Tracers", "Draws lines toward tracked targets on your screen."),
  NAME_TAGS("name_tags", "Name Tags", "Shows cleaner distance and health labels for tracked targets."),
  ZOOM("zoom", "Zoom", "Narrows your field of view for easier long-range aiming."),
